...
def resolve_workspace_dir(
    ...
    # Add to .env for docker env interpolation
...
def print_summary(alcatrazer_dir: Path, workspace_dir: Path) -> None:
    ...
    print("  2. The legacy `docker compose` workflow has been retired.")
    print("     Use `alcatrazer start` once the new orchestration lands —")
    print("     see docs/features/install_method.md.")
